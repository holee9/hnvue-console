...
/// <summary>
/// Unit tests for PositioningAndPreviewHandler state transitions.
/// SPEC-WORKFLOW-001: Workflow state management tests.
/// </summary>
public class PositioningAndPreviewHandlerTests
{
    private readonly PositioningAndPreviewHandler _sut;
    private readonly StudyContext _context;

    public PositioningAndPreviewHandlerTests()
    {
        var logger = new NullLogger<PositioningAndPreviewHandler>();
        _sut = new PositioningAndPreviewHandler(logger);
    ...
    public async Task EnterAsync_LogsStateEntry_Succeeds()
    {
        ...
        _sut.State.Should().Be(WorkflowState.PositionAndPreview);
    }
    ...
    [Fact]
    public void State_ReturnsPositionAndPreview()
    {
        // Arrange & Act
