...
if [ -f "/home/drake/go/bin/moai" ]; then
	exec "/home/drake/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/home/drake/.local/bin/moai" ]; then
	exec "/home/drake/.local/bin/moai" statusline < "$temp_file"
fi
